...
;// Client: The Top Secret Agency.
;// Description: This file contains the implementation of the Compute procedure
;//					requested by the Top Secret Agency.
;//	Extra Credit: 
;//					1. The procedure will correctly sum any two 16-bit signed integers.
;//					2. The procedure will generate a random key_map if operation
;//						mode 3 is selected.
...
Compute		PROC
	...
	;// This operation mode will perform if any integer other than -3, -2, and -1 is passed
	;// to the procedure.
	Next_0:
